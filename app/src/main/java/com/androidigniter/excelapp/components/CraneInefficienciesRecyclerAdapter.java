...
public class CraneInefficienciesRecyclerAdapter extends RecyclerView.Adapter<CraneInefficienciesRecyclerAdapter.ViewHolder> {

    private List<CraneInefficienciesResponse> mData;
    ...
    public CraneInefficienciesRecyclerAdapter(Context context, ArrayList<CraneInefficienciesResponse> data, ProjectRepository projectRepo, WTGRepository wtgRepo, CraneRepository craneRepo) {

        this.mInflater = LayoutInflater.from(context);
        this.mData = data;
        projectRepository = projectRepo;
        wtgRepository = wtgRepo;
        craneRepository = craneRepo;
    }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        CraneInefficienciesResponse task = mData.get(position);
    ...
    CraneInefficienciesResponse getItem(int id) {
        return mData.get(id);
    }
