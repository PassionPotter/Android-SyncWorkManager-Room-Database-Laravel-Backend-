...
public class TrazabilityRecyclerAdapter extends RecyclerView.Adapter<TrazabilityRecyclerAdapter.ViewHolder> {

    private List<TrazabilityResponse> mData;
    private LayoutInflater mInflater;
    private ItemClickListener mClickListener;

    private WTGRepository wtgRepository;
    // data is passed into the constructor
    public TrazabilityRecyclerAdapter(Context context, ArrayList<TrazabilityResponse> data, WTGRepository wtgRepo) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        TrazabilityResponse task = mData.get(position);
    ...
    TrazabilityResponse getItem(int id) {
        return mData.get(id);
    }
