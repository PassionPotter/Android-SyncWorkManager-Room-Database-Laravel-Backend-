...
public class CraneInefficienciesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_crane_inefficiencies);


        projectViewModel = ViewModelProviders.of(this).get(ProjectViewModel.class);

        partial_time = findViewById(R.id.crane_inefficiencies_partial_time_input);
        partial_time.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new TimePickerDialog(CraneInefficienciesActivity.this, partialTimeListener ,myCalendar.get(Calendar.HOUR_OF_DAY),myCalendar.get(Calendar.MINUTE), true).show();
            }
        });
        ...
        Spinner ots1 = (Spinner) findViewById(R.id.crane_inefficiencies_task_input);
        Spinner wtg = (Spinner) findViewById(R.id.crane_inefficiencies_wtg_input);
        Spinner responsible = (Spinner) findViewById(R.id.crane_inefficiencies_responsible_input);
        Spinner validated = (Spinner) findViewById(R.id.crane_inefficiencies_validated_input);
        Spinner cause = (Spinner) findViewById(R.id.crane_inefficiencies_cause_input);
        Spinner subcause = (Spinner) findViewById(R.id.crane_inefficiencies_subcause_input);
        Spinner project = (Spinner) findViewById(R.id.crane_inefficiencies_project_code_input);
        ...
        daily_date = findViewById(R.id.crane_inefficiencies_date_input);
        daily_date.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new DatePickerDialog(CraneInefficienciesActivity.this, datePickerListener ,myCalendar.get(Calendar.YEAR),myCalendar.get(Calendar.MONTH),myCalendar.get(Calendar.DAY_OF_MONTH)).show();
            }
        });



        Button saveBtn = findViewById(R.id.crane_inefficiencies_save_btn);
        ...
        Button task_list_btn = findViewById(R.id.crane_inefficiencies_list_btn);
        task_list_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(CraneInefficienciesActivity.this, CraneInefficienciesTaskListActivity.class);
                startActivity(i);
            }
        });
        ...
        Spinner craneSpinner = findViewById(R.id.crane_inefficiencies_crane_type_input);
    ...
    private void displayLoader() {
        pDialog = new ProgressDialog(CraneInefficienciesActivity.this);
    ...
    private void SaveData() {
        displayLoader();
        EditText hours = findViewById(R.id.crane_inefficiencies_hours_input);
        EditText justification = findViewById(R.id.crane_inefficiencies_justification_input);
        Switch shift_option = findViewById(R.id.crane_inefficiencies_shift_option_input);
        try {
            CraneInefficienciesResponse newResponse = new CraneInefficienciesResponse();
            newResponse.setProject(project_id);
            newResponse.setWtg(wtg_id);
            newResponse.setHours(Integer.valueOf(hours.getText().toString()));
            newResponse.setCrane_type(crane_id);
            ...
            projectViewModel.insertCraneInEfficiencies(newResponse);
